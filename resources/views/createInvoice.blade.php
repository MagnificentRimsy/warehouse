...
<div align="center" class="container" style=" padding: 20px;">
    ...
    <div class="box-typical panel panel-default">
        ...
        <div class="box-typical-body panel-body">
            ...
            <form method="post" action="{{url('create-invoice')}}"  class="form-horizontal" id="form" enctype="multipart/form-data" >
                ...
                <div class="form-group row">
                    ...
                    <select class="form-control" name="clid">
                        @foreach ($clients as $client)
                          <option value="{{$client->clid}}">{{$client->fname}} {{$client->sname}} ({{$client->companyName}} )</option>
                        @endforeach
                    </select>
                    </div>
                </div>
